...
Daphnia16S$unique_identifier <- word(Daphnia16S$Sequence_Labels, 1L,) #Getting identifiers from first "word" of label
...
hist(nchar(DaphniaOverlap$Daphnia18S_Nucleotide_Sequence)) #Histogram for 18S, majority of data is between 0 and 1000, 1 between 2000 and 3000, 3 between 5000 and 6000, 1 between 6000 and 7000.
...
BrowseSeqs(DaphniaOverlap.16S.alignment, htmlFile = paste(tempdir(), "/Daphnia16Overlap.S.Alignment.html", sep = "")) #Alignment looks good, nothing too strange
...
dend_diff(DaphniaOverlap18S_Dendogram, DaphniaOverlap16S_Dendogram)
